				...
				if(this.Requirements_Section)
					...
					foreach(MappingServiceTower objTower in parDataSet.dsMappingServiceTowers.Values.OrderBy(t => t.Title))
						...
						foreach(MappingRequirement objRequirement in parDataSet.dsMappingRequirements.Values
							.Where(r => r.MappingServiceTowerIDsp == objTower.IDsp).OrderBy(r => r.SortOrder).ThenBy(r => r.Title))
							{
							...
							if(this.Risks)
								...
								foreach(MappingRisk objRisk in parDataSet.dsMappingRisks.Values
									.Where(r => r.MappingRequirementIDsp == objRequirement.IDsp).OrderBy(r => r.Title))
									{
							...
							if(this.Assumptions)
								...
								foreach(MappingAssumption objAssumption in parDataSet.dsMappingAssumptions.Values
									.Where(a => a.MappingRequirementIDsp == objRequirement.IDsp).OrderBy( a => a.Title))
									{
							...
							if(this.Deliverable_Reports_and_Meetings)
								...
								foreach(var objMappingDeliverable in parDataSet.dsMappingDeliverables.Values
									.Where(d => d.MappingRequirementIDsp == objRequirement.IDsp).OrderBy(d => d.Title))
									{
									if(!bWrittenTitle)
										{
												...
												if(objDeliverableLayer2up.CSDdescription != null)
													...
													try
														...
														objHTMLdecoder.DecodeHTML(parClientName: parClientName,
															parMainDocumentPart: ref objMainDocumentPart,
															parDocumentLevel: 5,
															parHTML2Decode: HTMLdecoder.CleanHTML(objDeliverableLayer2up.CSDdescription, parClientName),
														...
														if(objDeliverableLayer2up.DDobligations != null)
															...
															try
																...
																objHTMLdecoder.DecodeHTML(parClientName: parClientName,
																	parMainDocumentPart: ref objMainDocumentPart,
																	parDocumentLevel: 6,
																	parHTML2Decode: HTMLdecoder.CleanHTML(objDeliverableLayer2up.DDobligations, parClientName),
																	parContentLayer: currentContentLayer,
																	parTableCaptionCounter: ref tableCaptionCounter,
																	parImageCaptionCounter: ref imageCaptionCounter, parNumberingCounter: ref numberingCounter,
																	parPictureNo: ref iPictureNo,
														...
														if(objDeliverableLayer2up.ClientResponsibilities != null)
															...
															try
																...
																objHTMLdecoder.DecodeHTML(parClientName: parClientName,
																	parMainDocumentPart: ref objMainDocumentPart,
																	parDocumentLevel: 6,
																	parHTML2Decode: HTMLdecoder.CleanHTML(objDeliverableLayer2up.ClientResponsibilities, parClientName),
																	parContentLayer: currentContentLayer,
																	parTableCaptionCounter: ref tableCaptionCounter,
																	parImageCaptionCounter: ref imageCaptionCounter, parNumberingCounter: ref numberingCounter,
																	parPictureNo: ref iPictureNo,
																...
																// A Table content error occurred, record it in the error log.
																this.LogError("Error: The Document Collection ID: " + this.DocumentCollectionID
																	+ " contains an error in Client's responsibilies Enhance Rich Text. "
														...
														if(objDeliverableLayer2up.Exclusions != null)
															...
															try
																...
																objHTMLdecoder.DecodeHTML(parClientName: parClientName,
																	parMainDocumentPart: ref objMainDocumentPart,
																	parDocumentLevel: 6,
																	parHTML2Decode: HTMLdecoder.CleanHTML(objDeliverableLayer2up.Exclusions, parClientName),
																	parContentLayer: currentContentLayer,
																	parTableCaptionCounter: ref tableCaptionCounter,
																	parImageCaptionCounter: ref imageCaptionCounter, parNumberingCounter: ref numberingCounter,
																	parPictureNo: ref iPictureNo,
														...
														if(objDeliverableLayer2up.GovernanceControls != null)
															...
															try
																...
																objHTMLdecoder.DecodeHTML(parClientName: parClientName,
																	parMainDocumentPart: ref objMainDocumentPart,
																	parDocumentLevel: 6,
																	parHTML2Decode: HTMLdecoder.CleanHTML(objDeliverableLayer2up.GovernanceControls, parClientName),
																	parContentLayer: currentContentLayer,
																	parTableCaptionCounter: ref tableCaptionCounter,
																	parImageCaptionCounter: ref imageCaptionCounter, parNumberingCounter: ref numberingCounter,
																	parPictureNo: ref iPictureNo,
											...
											if(this.Acronyms_Glossary_of_Terms_Section)
												...
												if(objDeliverable.GlossaryAndAcronyms != null)
													...
													foreach(var entry in objDeliverable.GlossaryAndAcronyms)
														{
														if(this.DictionaryGlossaryAndAcronyms.ContainsKey(entry) != true)
															DictionaryGlossaryAndAcronyms.Add(entry, string.Empty);
														}
													}
